...
public class AiderHelper {
                    ...
                    if (output != null && containsDuplicateHint(output)) {
                        ...
                        ApplicationManager.getApplication().invokeLater(() -> {
                            ...
                            if (choice == Messages.YES) {
                                runRefactorWithPreview(project, filePath, provider, model, apikey, aiderPath, apiBase, apiVersion);
                            }
                        });
                    } else {
                        ApplicationManager.getApplication().invokeLater(() -> {
    ...
    private static void runRefactorWithPreview(Project project, String filePath, String provider, String model, String apikey, String aiderPath, String apiBase, String apiVersion) {
